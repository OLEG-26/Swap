...
<body>
  ...
  <header>
    <nav class="navbar justify-content-center">
      ...
      <form class="input-group col-lg-4 col-md-3 col-sm-12" action="searchWoutAcc.php" method="post">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="login">
              ...
              <form action="php/login_functionality.php" method="POST">
                ...
                <div class="newhere">
                <span>New in this site? <a href="signup.php">click here</a> to Sign up</span>
                </div>
              </form>
