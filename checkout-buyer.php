    ...
    <body>
        ...
        <main>
            <div class="section-1">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <?php
                              echo "<div class='buyer-side'>
                                      ...
                                      <h5 class='item'>Item: $order_offer</h5>
                ...
                <div class="buttons">
                    <?php
                        echo "<a href='php/accept.php?order_id=$order_id&product_id=$product_id&receiver_id=$seller_id&buyer=$buyer_name&buyer_id=$buyer_id&seller_name=$seller_name'><button class='btnacpt' type='submit'>Accept</button></a>";
                    ?>
                    <a href="notifications.php"><button class="btncnl" type="button">Cancel</button></a>
                </div>
            </div>
        </main>
