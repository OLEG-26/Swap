<?php
    ...
    if(validationCheck())
    {
        ...
        {
            $sql = "INSERT INTO user_information (First_name, Last_name, Email, Username, Contact, Address, gender, password, id_pic, profile_pic, social_account, isActive) VALUES ('$firstname', '$lastname', '$email', '$username', $contact, '$address', '$gender', '$password', '$fileDestination', '../uploads/profile-picture//blank_dp.png', 'Not yet registered', 'active')";
