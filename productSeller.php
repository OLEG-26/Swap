        ...
        <?php
            ...
            if(isset($_SESSION["productID"]))
            {
                ...
                else
                {
                  ...
                  $seller_id = $product_data['product_seller_id'];
                }
            }
          ?>
            <div class="row">
                ...
                <div class=" col-md-6 col-sm-12 ">
                  ...
                  <?php
                    ...
                    {
                      //id of the current comment iteration
                      $comment_offer = $row["comment_offer"];
                      //get the data of the commentor
                      ...
                      echo "<div class='comments'>
                              ...
                              <div class='hide'>
                                  <a href='checkout.php?buyer_id=$commentor_id&seller_id=$seller_id&product_id=$product_id&comment_offer=$comment_offer'><input type='button' class='acceptbtn' value='Accept Offer'/></a>
                              </div>
                            </div>";
                    }       
                  ?>   
                  ...
                  <div class="comment">
                    <textarea type="text" id="preferred_items" name="preferred_items" disabled required rows="3" column="100" class="form-control md-textarea" placeholder="You are the seller of this product, you can't comment an offer."></textarea>
                    <button class="post" type="submit" disabled>post</button>
                  </div>
          <br>
                </div>
              </div>
