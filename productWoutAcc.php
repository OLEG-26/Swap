...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="./CSS/productWoutAcc.css"/>
        ...
        <header>
            <nav class="navbar justify-content-center">
              <div class="col-lg-4 col-md-4 col-sm-12">
                <a  style="color: whitesmoke;" class="navbar-brand" href="indexWOutAcc.php"><img src="./image/white_logo.webp" alt="logo" >Swap</a>
              </div>
                    ...
                    <div class="nav-bar mx-auto">
                       <ul class="nav">
                          <li class="nav-item col-lg-4 col-md-4 col-sm-12">
                             <a class="nav-link active" href="indexWOutAcc.php">Home</a>
                          </li>
                       </ul>
                    </div>
                  </div>
          ...
          ?>
            <div class="row">
                <div class="col-md-6 col-sm-12 pt-5">
                  <?php
                    //echo the necessary information about the product
                    ...
                    echo "<div class='description'>
                            ...
                            <p class='item-desc'>$product_desc</p>
                ...
                <div>
                  <div class="name">
                    <h5 class="profilename">Guest</h5>
                  </div>
                  <div class="comment">
                    <textarea type="text" id="preferred_items" name="preferred_items" disabled required rows="3" column="100" class="form-control md-textarea" placeholder="Please log in first before commenting."></textarea>
                    <a href="login.php"><button class="post" type="submit">login</button></a>
                  </div>
                  <br>
                </div>
              </div>
